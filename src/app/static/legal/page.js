            ...
            <div>
              {activeTab === 'terms' && (
                <div className="space-y-4">
                  ...
                  <p className="text-base text-black">
                    Owner: QONSIUS VENTURES, S. L., (hereinafter, “QONSIUS”) <br />
                    Registered office: Dublin 1, Local 5, Europolis Las Rozas, 28232, Madrid, Spain. <br />
                    Tax identification number: B-87804167 <br />
              ...
              {activeTab === 'privacy' && (
                <div className="space-y-4">
                  ...
                  <p className="text-base text-black">
                    Company name: QONSIUS VENTURES, S. L., (hereinafter, “QONSIUS”) <br />
                    Registered office: Dublin 1, Local 5, Europolis Las Rozas, 28232, Madrid, Spain. <br />
                    Tax identification number: B-87804167 <br />
                    Public Registry: Registro Mercantil de Madrid, Tomo 35679, Folio 194, Hoja M-641219. <br />
                    Telephone number: +34 910 530 783 <br />
              ...
              {activeTab === 'cookies' && (
                ...
                <p className="text-base text-black">
                  ...
                  Legal Notice and the Privacy Policy. QONSIUS VENTURES, S.L., (“QONSIUS”) it is the owner of the Website and it 
                  is located at Dublin 1, Local 5, Europolis Las Rozas, 28232, Madrid, Spain, with N.I.F. B87804167. In this regard, 
